      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-xl font-bold mb-4">🎓 StudentFreelance</h3>
            <p className="text-gray-400 text-sm md:text-base">
              Empowering students to turn their skills into income while gaining real-world experience.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Get Mentorship</a></li>
