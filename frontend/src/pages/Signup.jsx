...
const Signup = () => {
    const [formData, setFormData] = useState({
        ...
        email: '',
        password: '',
        password2: '', // For the 'Confirm Password' field
        role: 'student' // Default role
    });

    const [error, setError] = useState(''); // To display errors from the backend
    ...
    const onSubmit = async e => {
        ...
        // The keys (name, email, etc.) MUST match your backend User model
        const newUser = {
            name,
            email,
            password,
        ...
        try {
            ...
            console.log('SUCCESS!', res.data); // This will log the token
            setError('');
            // TODO: Handle success (e.g., save token, redirect to login/dashboard)

        } catch (err) {
            // The err.response.data will contain the error message from your backend
